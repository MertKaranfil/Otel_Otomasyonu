...
{
    public partial class FrmOda202 : Form
    {
        public FrmOda202()
        {
            InitializeComponent();
        ...
        private void verilerigoster()
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("select * from Oda202", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("delete from Oda202 where id=(" + id + ")", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("update Oda202 set Adi='" + txtAd.Text + "',Soyadi='" + txtSoyad.Text + "'where id=" + id + "", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
            verilerigoster();
        ...
        private void btnVerileriGoster_Click_2(object sender, EventArgs e)
        {
            verilerigoster();
        }
    }
