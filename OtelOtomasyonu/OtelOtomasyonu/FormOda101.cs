...
namespace OtelOtomasyonu
{
    public partial class FormOda101 : Form
    {
      ...
      //   SqlConnection baglanti = new SqlConnection(@"Data Source=DESKTOP-UUOUMLQ\SQLEXPRESS;Initial Catalog=OtelOtomasyonu;Integrated Security=True");
        ...
        {
            /*baglanti.Open();
            SqlCommand komut = new SqlCommand("update Oda101 set Adi='" + txtAd.Text + "',Soyadi='" + txtSoyad.Text + "'where id=" + id + "", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
            verilerigoster();
        ...
        private void FormOda101_Load(object sender, EventArgs e)
        {
        ...
        private void pBoxSprite_Click(object sender, EventArgs e)
        {
